...
for (i in seq(1, length(filtered_parentage_data$LD.1_ratio))) {
  ...
  filtered_parentage_data$z_score_dad[i] <- list(z_score_dad)
...
for (i in seq(1, length(filtered_parentage_data$LD.2_ratio))) {
  ...
  filtered_parentage_data$z_score_mom[i] <- list(z_score_mom)
...
for (i in seq(1, length(filtered_parentage_data$LD_ratio))) {
  ...
  filtered_parentage_data$z_score_offspring[i] <- list(z_score_offspring)
